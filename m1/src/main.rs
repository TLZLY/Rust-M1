...
fn accrue_interest(user: &mut User, interest: f32, mut years: i32) {
    if years > 99 {
        println!("Maximum years is 99, please try again.");
    }
    else {
            for _ in 1..=years {
